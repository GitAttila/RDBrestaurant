...
var _MobileMenu = __webpack_require__(90);

var _MobileMenu2 = _interopRequireDefault(_MobileMenu);

var _carousels = __webpack_require__(97);
...
/*jshint esversion: 6 */
console.log((0, _jquery2.default)(".site-header__menu-icon"));
...
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(2), __webpack_require__(99)) :
  undefined;
...
var ScrollingActions = function () {
    ...
    (0, _createClass3.default)(ScrollingActions, [{
        ...
        value: function createWaypoints() {
            ...
            new Waypoint({
                ...
                handler: function handler() {
                    ...
                    (0, _jquery2.default)("#site-header").toggleClass('site-header--transparent');
                },
                offset: '10%'
            });
        }
        ...
        key: 'scrollTo',
        value: function scrollTo(elem, scrollToPos) {
            (0, _jquery2.default)(elem).animate({
